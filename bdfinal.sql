...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02/12/2024 às 01:48
...
(5, 'cara', 'eeee', 'aaaa', 'sapato', '2,00', 13, 2.00),
(6, 'legal', 'sdv', 'aszxczsdc', 'asdasd', '0,00', 8, 0.00),
...
(13, 'sapato', '12345678', 'sapatos.web', 'WebSapato', 'sapataria', 19, 0.00);
...
--
-- Despejando dados para a tabela `mei_produto`
--
...
(6, 'ronnie coleman', 'ricoemmelanina@gmail.com', '123', '123123123'),
(7, 'pedro', 'pedroamalfi@gmail.com', '123', '19 945345435'),
(9, 'wqe', 'adsfa', '123', 'awd'),
(10, 'sapatos', 'arroz@gmail.com', '321', '162521'),
(11, 'teste', 'teste@gmail.com', '123', '1592152');
...
--
ALTER TABLE `usuario_permissao`
  MODIFY `id_relacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
